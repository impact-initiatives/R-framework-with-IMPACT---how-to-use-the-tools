...
Autant que possible, les fonctions **check\_**\* prennent des arguments par défaut ou les fonctions tentent deviner certaines informations, par exmple, la fonction `check_outliers` devine quelles colonnes contiennent des valeurs numériques. Certaines fonctions ont besoin de plus d'informations.

## autres/colonne texte

`check_other` nécessite la liste des colonnes à vérifier. Actuellement, elle ne peut pas détecter les questions ouvertes. L'outil KOBO peut être utilisé.
