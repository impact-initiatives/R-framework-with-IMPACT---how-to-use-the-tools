...
The palette must have enough colours to match the number of categories. In the example below, the `impact` palette has only 3 colours, whereas the graphic needs 4.
