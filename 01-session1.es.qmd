...
-   **4 verbos**: 
    -   **Add**: (añadir) functiones que añaden una nueva variable (columna) a los datos.
    -   **Check**: (verificar) functiones que maracarán valores basándose en una verificación específica. Retornará estos valores en un registro. Una función check_* devolverá una lista: el conjunto de datos verificado y el registro. La función toma un conjunto de datos como entrada y devuelve el conjunto de datos + el nuevo indicador (y cualquier paso intermedio utilizado para el cálculo).
